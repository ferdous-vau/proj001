                        ...
                        <form id="msform" >
                            ...
                            <fieldset>
                                <div class="form-card">
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-check ">
                                        <input class="form-check-input mt-1" style="width: 20px"  type="radio" name="flexRadioDefault" id="flexRadioDefault2" checked>
                                        <label class="form-check-label" for="flexRadioDefault2">
                                          CSE-3300
                                        </label>
                                      </div>
                                      <div class="form-check ">
                                          <input class="form-check-input mt-1" style="width: 20px" type="radio" name="flexRadioDefault" id="flexRadioDefault1">
                                ...
                                <input type="button" name="previous" class="previous action-button-previous" value="Previous" />
                                 <input type="button" name="" class="next action-button" value="Confirm" />
                            </fieldset>
                            <fieldset>
                                <div class="form-card">
